...
class EventController {
    ...
    EventController(EventService eventService, EventRepository eventRepository, AuditRepository auditRepository,
    ...
    List<AuditEntryResponse> auditEntries(@PathVariable String eventId) {
        return eventService.auditEntries(eventId);
    }
    ...
    HealthResponse health() {
        ...
        return new HealthResponse("event-gateway", databaseUp ? "UP" : "DOWN", Instant.now(), Map.of(
                ...
                "auditRows", databaseUp && auditRepository.databaseAvailable() ? auditRepository.countRows() : "unavailable",
