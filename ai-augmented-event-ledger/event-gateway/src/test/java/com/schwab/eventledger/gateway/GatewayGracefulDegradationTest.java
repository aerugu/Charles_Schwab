...
class GatewayGracefulDegradationTest {
    ...
    void setUp() {
        ...
        eventService = new EventService(
                eventRepository,
                auditRepository,
                new UnavailableAccountClient(objectMapper),
                new EventSubmissionLocks()
        );
    ...
    void postEventsQueueLocallyWhenAccountServiceIsDown() {
        ...
        assertThat(auditRepository.findByEventId("graceful-post-001"))
                .extracting(AuditEntryResponse::action)
                .containsExactly("EVENT_ACCEPTED", "EVENT_QUEUED_FOR_RETRY");
